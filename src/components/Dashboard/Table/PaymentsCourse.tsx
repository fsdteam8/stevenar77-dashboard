                  ...
                  <td className="px-6 py-4 text-center">
                    <Dialog>
                      ...
                      <DialogContent className="sm:max-w-3xl p-6 rounded-2xl shadow-2xl bg-white border border-gray-200 max-h-[80vh] overflow-y-auto">
                        ...
                        <DialogClose asChild>
                          <button className="mt-8 w-full md:w-auto px-5 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200 cursor-pointer">Close</button>
                        </DialogClose>
                      </DialogContent>
                    </Dialog>
                  </td>
