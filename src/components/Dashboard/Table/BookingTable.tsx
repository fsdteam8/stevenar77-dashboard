        ...
        <table className="w-full">
          ...
          <tbody className="bg-white divide-y divide-gray-100">
            {paginatedData.map((booking) => {
              // Split customerName into first and last name
              const customerNameParts = booking.customerName?.split(" ");
              const initials =
                customerNameParts?.length >= 2
                  ? customerNameParts[0][0].toUpperCase() +
                    customerNameParts[1][0].toUpperCase()
                  : customerNameParts?.[0]?.[0]?.toUpperCase();
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      {/* {booking.avatar ? (
                        ...
                        // Display initials if no avatar exists
                        <div className="flex justify-center items-center w-10 h-10 bg-gray-300 text-white font-bold text-lg rounded-full">
                          {initials}
                        </div>
                      )} */}
